# JARVISv5 Merged Development Roadmap (Weighted v3 - Tools Update)
...
> More detail regarding conceptual design and architecture guidance found in `roadmap-20260223-tools.md` 
...
- Deferred (post-M5 security): Tier 3 Code Execution tools — `execute_python`, `execute_shell`, and expanded home-directory filesystem access (`Path.home()`).
