...
## Pre-Phase Gate — Repository Hygiene (Not a Milestone)
...
## Milestone 1 — Production Local Model Management
...
### Deliverables
- Production model catalog (size/profile-aware)
- Checksum verification on download/load
- Hardware-profiled routing defaults
- Resumable/reliable model fetch
- Daily-driver model default with explicit opt-in for test models
...
## Milestone 2 — DAG Control-Plane Completion
...
## Milestone 3 — Baseline Determinism Harness
...
## Milestone 6 — Redis Caching Integration
